...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\iHateDave\PycharmProjects\HexTrackApp\Hextrack'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\iHateDave\PycharmProjects\HexTrackApp\Hextrack\Scripts\deactivate.nu'
